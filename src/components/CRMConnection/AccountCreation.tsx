import { Button, Card, Checkbox, Divider, Flex, Paper, Select, Text } from '@mantine/core';
    ...
    <Paper withBorder m='xs' p='lg' radius='md' bg={'#fcfcfd'}>
      <Flex direction={'column'} mb={'md'}>
        ...
        <Text color='gray' size={'sm'}>
          Automatically trigger creation of accont/ contact/ opportunity based on SellScale events.
        </Text>
      </Flex>
      <Divider />
