import { Button, Box, Card, Flex, Grid, Text, Paper, SimpleGrid, TextInput, NumberInput, Group } from '@mantine/core';
...
export default function WebsiteIntent() {
  ...
  const splitsData = [
    ...
    },
    {
      ...
      logo_two_url: 'https://creativecomp.com/wp-content/uploads/2021/04/Hulu-logo-modern-font.png',
      logo_three_url: 'https://cdn4.iconfinder.com/data/icons/flat-brand-logo-2/512/amazon-512.png',
      ...
      {detailView ? (
        <Box>
          <Card>
            ...
            <Line data={data} options={options} style={{ width: '100%', maxHeight: '300px', height: '250px' }} />
          </Card>
          <Flex justify={'space-between'} align={'center'} mt='md'>
            ...
            <Button
              ...
              onClick={() =>
                openContextModal({
                  modal: 'websiteintentsplit',
                  title: (
                    <Group position='apart'>
                      <Text size={24} fw={600}>
                        Create New Website Intent Split
                      </Text>
                    </Group>
                  ),
                  styles: (theme) => ({
