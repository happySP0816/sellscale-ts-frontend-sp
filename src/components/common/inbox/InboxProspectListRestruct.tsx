...
export function InboxProspectListRestruct(props: { buckets: ProspectBuckets, refetch: () => void }) {
  ...
  return (
    ...
    <Modal
      ...
      onClose={() => { setShowClearInboxModal(false); setOpenedList(true); props.refetch();fetchAIConversations(); }}
      size="xxl"
                          ...
                          <Flex align={"center"} w={"100%"} justify={"space-between"}>
                            <Text fw={600} size={"sm"}>
                              ...
                              {AIinboxPerformance.num_revivals_attempted
                                ? Math.floor((AIinboxPerformance.actual_revivals * 100) / AIinboxPerformance.num_revivals_attempted)
                                : 0}
                              %
                            </Text>
                            <Tooltip
                    ...
                    <Popover width={280} position="bottom" withArrow shadow="md">
                      <Popover.Target>
                        <ActionIcon variant="transparent">
                          <IconAdjustmentsHorizontal size={"1.4rem"} color="gray" />
                        </ActionIcon>
                      </Popover.Target>
                      <Popover.Dropdown>
                        <Stack spacing={"xs"}>
                          ...
                          <Select
                            ...
                            label="Sort by:"
                          />
                          <Select data={[{ label: "Search by name", value: "name" }]} label="Filter By:" placeholder="Select" />
                          <Switch labelPosition="left" label="Show starred chats on top" defaultChecked />
                          <Divider />
                                ...
                                <ProspectConvoCard
                                  ...
                                  latest_msg={
                                    ...
                                    prospect.li_last_message_timestamp
                                      ? prospect.email_last_message_timestamp > prospect.li_last_message_timestamp
                                        ? prospect.email_last_message_from_prospect
                                        : prospect.li_last_message_from_prospect
                                      : prospect.email_last_message_from_prospect ?? prospect.li_last_message_from_prospect) ?? ""
                                  }
                                  latest_msg_time={
                                    (prospect.email_last_message_timestamp && prospect.li_last_message_timestamp
                                      ? prospect.email_last_message_timestamp > prospect.li_last_message_timestamp
