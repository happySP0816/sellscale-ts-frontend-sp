...
const ICPFiltersDashboard = (props: ICPFiltersDashboardPropsType) => {
  ...
  const [
    selectedProspectStatusFilter,
    setSelectedProspectStatusFilter,
  ...
  useEffect(() => {
    ...
    if (
      ...
      selectedTab.label !== "Do Not Contact"
    ) {
      newFilters = [
        ...newFilters,
        {
        ...
        <Stack>
                      ...
                      children: (
                        <>
                          <Text>
                            ...
                            {Object.keys(selectedRows).length} prospects? This
                            will move them into your Unassigned Contacts list.
                          </Text>
                          <Text mt="xs">
          ...
          <Paper radius={"8px"}>
            <Flex gap={"sm"}>
              ...
              <Box
                maw={
                  sideBarVisible ? "calc(100vw - 580px)" : "calc(100vw - 200px)"
                }
              >
                <GridTabs
                ...
                <DataGrid
                  ...
                  columns={[
                    ...
                    },
                    {
                      ...
                      cell: (cell) => {
                        return (
                          <Text size="xs">{cell.cell?.getValue<string>()}</Text>
                        );
                      },
                    },
                    {
                      ...
                      cell: (cell) => {
                        ...
                        const valid = cell.row.original
                          .valid_primary_email as boolean;
                        return (
                          <Text size="xs">
                            {email ? `${email} ${valid ? "✅" : ""}` : "-"}
                          </Text>
                    ...
                    },
                    {
                      ...
                      cell: (cell) => {
                        ...
                        if (cell.cell?.getValue<string>() === "PROSPECTED") {
                          ...
                          cell.cell?.getValue<string>() === "ACTIVE_CONVO"
                        ) {
                          color = "purple";
                        } else if (cell.cell?.getValue<string>() === "DEMO") {
                          color = "green";
                        } else if (
                          cell.cell?.getValue<string>() === "REMOVED"
                        ) {
                          color = "red";
                        }
                        return (
