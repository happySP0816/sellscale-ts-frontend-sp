    ...
    <Grid mt="md">
      <Grid.Col span={12} lg={3} sm={6}>
        <Card radius="md" withBorder w={"100%"} p={0}>
          ...
          <Button variant="light" size="md" fullWidth rightIcon={<IconArrowRight size={"1.2rem"} />} onClick={() => (window.location.href = "/campaigns")}>
            View Details
          </Button>
        </Card>
      </Grid.Col>
      <Grid.Col span={12} lg={3} sm={6}>
        <Card radius="md" withBorder w={"100%"} p={0}>
          ...
          <Button variant="light" color="orange" size="md" fullWidth rightIcon={<IconArrowRight size={"1.2rem"} />}>
            View Details
          </Button>
        </Card>
      </Grid.Col>
      ...
      <Grid.Col span={12} lg={3} sm={6}>
        <Card radius="md" withBorder w={"100%"} p={0}>
          ...
          <Button variant="light" color="green" size="md" fullWidth rightIcon={<IconArrowRight size={"1.2rem"} />}>
            View Details
          </Button>
        </Card>
      </Grid.Col>
