                  ...
                  <Box>
                    <Flex align={'center'} gap={'sm'}>
                      ...
                      {sub_segments && sub_segments.length > 0 && (
                        ...
                        >
                          {expandedRows.includes(id) ? 'Hide' : 'Show'} {sub_segments.length} Sub-Segments
                        </Badge>
                      )}
                    </Flex>
  ...
  return (
    <Paper>
      ...
      <Modal
        ...
        zIndex={1000}
      >
        <iframe src={iframeUrl} width={window.innerWidth - 400} height={window.innerHeight} style={{ border: 'none' }}></iframe>
      </Modal>
