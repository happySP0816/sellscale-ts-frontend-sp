        ...
        <div className='bg-white'>
          <Flex direction={'column'} py={'lg'} gap={'lg'}>
              ...
              <Flex px={'md'} sx={{ border: '1px solid #dee2e6', borderRadius: '8px' }} w={'100%'} align={'center'} gap={'xl'} h={'fit-content'}>
                ...
                <Box w={'100%'}>
                  ...
                  <Text color='gray'>
                    ...
                    >
                      {outboundData?.message_active?.toLocaleString() || 0} / {outboundData?.message_total?.toLocaleString() || 0}
                    </span>{' '}
            ...
            <Flex direction={'column'} gap={'sm'}>
              ...
              <Collapse in={activeCampaign.length > 0 ? activeOpened : false}>
                <DataGrid
                  data={activeCampaign}
                  highlightOnHover
                  withPagination
            ...
            <Flex direction={'column'} gap={'sm'}>
              ...
              <Collapse in={repCampaign.length > 0 ? repOpened : false}>
                <DataGrid
                  data={repCampaign}
                  highlightOnHover
                  withPagination
            ...
            <Flex direction={'column'} gap={'sm'}>
              ...
              <Collapse in={aiCampaign.length > 0 ? aiOpened : false}>
                <DataGrid
                  data={aiCampaign}
                  highlightOnHover
                  withPagination
            ...
            <Flex direction={'column'} gap={'sm'}>
              ...
              <Collapse in={noCampaign.length > 0 ? noOpened : false}>
                <DataGrid
                  data={noCampaign}
                  highlightOnHover
                  withPagination
            ...
            <Flex direction={'column'} gap={'sm'}>
              ...
              <Collapse in={completedCampaign.length > 0 ? completeOpened : false}>
                <DataGrid
