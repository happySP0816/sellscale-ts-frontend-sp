...
export async function createResearcher(userToken: string, name: string): Promise<MsgResponse> {
...
export async function getArchetypeQuestions(userToken: string, id: number): Promise<MsgResponse> {
  const response = await fetch(`${API_URL}/ml/researchers/archetype/${id}/questions`, {
    method: 'GET',
    headers: {
      Authorization: `Bearer ${userToken}`,
    },
...
export async function getResearcherQuestions(userToken: string, researcherNumber: number): Promise<MsgResponse> {
  const response = await fetch(`${API_URL}/ml/researchers/${researcherNumber}/questions`, {
    method: 'GET',
    headers: {
      Authorization: `Bearer ${userToken}`,
    },
...
export async function deleteResearcherQuestion(userToken: string, questionNumber: number): Promise<MsgResponse> {
  const response = await fetch(`${API_URL}/ml/researchers/questions/${questionNumber}`, {
    method: 'DELETE',
    headers: {
      Authorization: `Bearer ${userToken}`,
